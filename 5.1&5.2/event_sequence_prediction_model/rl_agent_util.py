...
class RlNetworkAgent:
    ...
    def get_var_strng(self, disable_explore = False):
        """
...
def demo_nodeclass():
    ...
    newAgent = RlNetworkAgent(5, 2, epsilon = 0.1, seed = 42, use_radial_traversal=True)
